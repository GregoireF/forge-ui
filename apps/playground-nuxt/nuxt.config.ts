  ...
  vite: {
    resolve: {
      alias: {
        ...
        "@forge-ui/avatar": fileURLToPath(new URL("../../packages/primitives/avatar/src/index.ts", import.meta.url)),
        ...
        "@forge-ui/date-field": fileURLToPath(new URL("../../packages/primitives/date-field/src/index.ts", import.meta.url)),
        "@forge-ui/date-picker": fileURLToPath(new URL("../../packages/primitives/date-picker/src/index.ts", import.meta.url)),
        "@forge-ui/date-range-picker": fileURLToPath(new URL("../../packages/primitives/date-range-picker/src/index.ts", import.meta.url)),
        ...
        "@forge-ui/number-input": fileURLToPath(new URL("../../packages/primitives/number-input/src/index.ts", import.meta.url)),
        ...
        "@forge-ui/separator": fileURLToPath(new URL("../../packages/primitives/separator/src/index.ts", import.meta.url)),
        ...
        "@forge-ui/time-picker": fileURLToPath(new URL("../../packages/primitives/time-picker/src/index.ts", import.meta.url)),
        "@forge-ui/toggle": fileURLToPath(new URL("../../packages/primitives/toggle/src/index.ts", import.meta.url)),
        "@forge-ui/toggle-group": fileURLToPath(new URL("../../packages/primitives/toggle-group/src/index.ts", import.meta.url)),
        "@forge-ui/tooltip": fileURLToPath(new URL("../../packages/primitives/tooltip/src/index.ts", import.meta.url)),
        "@forge-ui/visually-hidden": fileURLToPath(new URL("../../packages/primitives/visually-hidden/src/index.ts", import.meta.url)),
      },
    },
  },
});
