...
test.describe("TagsInput — Vue (forge-ui)", () => {
  ...
  test("initial tag Vue is visible", async ({ page }) => {
    await expect(page.locator('[data-forge-scope="tags-input"]').getByText("Vue")).toBeVisible();
  });
