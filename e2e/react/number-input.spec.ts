...
test.describe("NumberInput — React (forge-ui)", () => {
  ...
  test("increment trigger has data-forge-part=increment-trigger", async ({ page }) => {
    await expect(increment(page)).toHaveAttribute("data-forge-part", "increment-trigger");
  });

  test("decrement trigger has data-forge-part=decrement-trigger", async ({ page }) => {
    await expect(decrement(page)).toHaveAttribute("data-forge-part", "decrement-trigger");
  });
