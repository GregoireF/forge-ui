...
// ---------------------------------------------------------------------------
// Item — provides item value context to its children
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Header — semantic heading wrapper
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Trigger — the button that opens/closes the item
// ---------------------------------------------------------------------------
...
function Trigger({ children, asChild, ...rest }: AccordionTriggerProps) {
  const api = useCtx();
  const value = useItemValue();
  // Strip Vue-cased event handler — React uses onKeyDown only
